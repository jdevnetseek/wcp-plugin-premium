...
function request_quotes_form_register_settings() {
	...
	*/
	...
	add_settings_field( 
		'quote_form_send_to_top_rated',
		'Sending Option Checkbox Label',
		'quote_form_send_to_top_rated_callback',
		'request_quotes_form_settings_option',
		'request_quotes_form_settings_section'
	);
	...
	// Send to top rated option
	register_setting( 'request_quotes_form_settings_option', 'quote_form_send_to_top_rated' );

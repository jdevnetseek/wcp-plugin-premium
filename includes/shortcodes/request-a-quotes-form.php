 ...
 */
    ...
    { 
        global $post,$wpdb;
        // Get Quotes Form Settings Data to render on Front Page style
                ...
                $output .= '<div class="form-box">';
                    ...
                    $output .= '<form method="post" action="" class="quotes-form-content" id="quotes-form-content">';
                       $output .= '<div id="form-success-message-popup" disabled style="display:none;">Request Sent</div>';
                        ...
                        $output .= '<div class="top-rated"><label class="top-rated-label-popup">'.$quote_form_send_to_top_rated.'<input type="checkbox" name="checkbox-id" id="checkbox-id-popup" value="1"><span class="checkmark-popup"></span></label></div>';
            ...
            $output .= '<div id="default-quotes-form-container">';
                ...
                $output .= '<p id="form-subtitle">'.$request_quotes_form_subtitle.'</p>';
                   $output .= '<form action="" method="post" class="quotes-form-content" id="quotes-form-content-default">';
                        ...
                        $output .= '<div class="top-rated"><label class="top-rated-label">'.$quote_form_send_to_top_rated.'<input type="checkbox" name="checkbox-id" id="checkbox-id" value="1"><span class="checkmark"></span></label></div>';

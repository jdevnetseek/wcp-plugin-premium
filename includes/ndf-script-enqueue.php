...
function ndf_enqueue(){
	...
	// wp_deregister_script( 'jquery' );
    	...
    	// wp_register_script( 'jquery', "https://code.jquery.com/jquery-migrate-3.3.2.js", array(), '3.3.2' );
	...
	wp_enqueue_script('ndf-uikit-main-js', NDF_BASE_URL . '/vendor/uikit/js/uikit.js', array( 'jquery' ) );
	...
	wp_script_add_data( 'ndf-data-filter', 'async/defer' , true );
